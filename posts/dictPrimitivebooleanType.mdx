---
title: "JavsScript/TypeScript 사전: Primitive boolean Type"
publishedAt: "2024-11-10"
summary: "JavsScript/TypeScript 이슈 사전 : Primitive boolean Type 편"
---
...
#### value || defaultValue ([Logical OR](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Logical_OR))
...
#### value?. ([Optional Chaining](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Optional_chaining))
- 설명 : 객체 속성에 접근한 값이 null이거나 undefined인 경우 에러를 방지하고, undefined를 반환하는 코드입니다.
